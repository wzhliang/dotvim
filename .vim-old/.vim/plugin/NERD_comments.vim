...
function s:DoComment(forceNested, isVisual, alignLeft, alignRight, isSexy, isToggle, isInvert) range
    ...
    let initCol = <SID>GetColWierd()
    let initLine = a:firstline
    ...
    elseif a:isToggle
	if <SID>IsCommentedNormOrSexy(a:firstline)
	    execute ':' . a:firstline . ',' . a:lastline .'call <SID>UncommentLines()'
	else
	    call <SID>CommentLines(0, a:alignLeft, a:alignRight, a:firstline, a:lastline)
	endif
...
function s:InvertComment(firstLine, lastLine) range
    ...
    while currentLine <= a:lastLine
        ...
        " the line isnt commented 
            ...
            call <SID>CommentLines(1, 0, 0, currentLine, currentLine)
            let currentLine = currentLine + 1
        endif
...
" set up the mappings to comment out lines
execute 'nnoremap <silent>' . g:NERD_com_line_toggle_map . ' :call <SID>DoComment(0, 0, 0, 0, 0, 1, 0)<cr><ESC>'
execute 'vnoremap <silent>' . g:NERD_com_line_toggle_map . ' :call <SID>DoComment(0, 1, 0, 0, 0, 1, 0)<cr><ESC>'
...
" ===========================================================================
execute 'nmenu <silent> Plugin.NERD_com.Comment<TAB>' . escape(g:NERD_com_line_map, '\') . ' :call <SID>DoComment(g:NERD_use_nested_comments_default, 0, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, 0, g:NERD_use_toggle_coms_default, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment<TAB>' . escape(g:NERD_com_line_map, '\') . ' :call <SID>DoComment(g:NERD_use_nested_comments_default, 1, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, &filetype =~ g:NERD_use_sexy_coms_default_regexp, g:NERD_use_toggle_coms_default, 0)<CR><ESC>'

execute 'nmenu <silent> Plugin.NERD_com.Comment\ Toggle<TAB>' . escape(g:NERD_com_line_toggle_map, '\') . ' :call <SID>DoComment(0, 0, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, 0, 1, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Toggle<TAB>' . escape(g:NERD_com_line_toggle_map, '\') . ' :call <SID>DoComment(0, 1, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, &filetype =~ g:NERD_use_sexy_coms_default_regexp, 1, 0)<CR><ESC>'

execute 'nmenu <silent> Plugin.NERD_com.Comment\ Nested<TAB>' . escape(g:NERD_com_line_nest_map, '\') . ' :call <SID>DoComment(1, 0, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, 0 ,0, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Nested<TAB>' . escape(g:NERD_com_line_nest_map, '\') . ' :call <SID>DoComment(1, 1, &filetype =~ g:NERD_left_align_regexp, &filetype =~ g:NERD_right_align_regexp, 0 ,0, 0)<CR><ESC>'
...
execute 'nmenu <silent> Plugin.NERD_com.Comment\ Invert<TAB>' . escape(g:NERD_com_line_invert_map, '\') . ' :call <SID>DoComment(0,0,0,0,0,0,1)<CR>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Invert<TAB>' . escape(g:NERD_com_line_invert_map, '\') . ' :call <SID>DoComment(0,1,0,0,0,0,1)<CR>'

execute 'nmenu <silent> Plugin.NERD_com.Comment\ Sexily<TAB>' . escape(g:NERD_com_line_sexy_map, '\') . ' :call <SID>DoComment(0,0,0,0,1,0,0)<CR>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Sexily<TAB>' . escape(g:NERD_com_line_sexy_map, '\') . ' :call <SID>DoComment(0,1,0,0,1,0,0)<CR>'
...
execute 'nmenu <silent> Plugin.NERD_com.Comment\ Align\ Left\ (nested)<TAB>' . escape(g:NERD_com_align_left_map, '\') . ' :call <SID>DoComment(1, 0, 1, 0, 0, 0, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Align\ Left\ (nested)<TAB>' . escape(g:NERD_com_align_left_map, '\') . ' :call <SID>DoComment(1, 1, 1, 0, 0, 0, 0)<CR><ESC>'
                                                           
execute 'nmenu <silent> Plugin.NERD_com.Comment\ Align\ Right\ (nested)<TAB>' . escape(g:NERD_com_align_right_map, '\') . ' :call <SID>DoComment(1, 0, 0, 1, 0, 0, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Align\ Right\ (nested)<TAB>' . escape(g:NERD_com_align_right_map, '\') . ' :call <SID>DoComment(1, 1, 0, 1, 0, 0, 0)<CR><ESC>'
                                                           
execute 'nmenu <silent> Plugin.NERD_com.Comment\ Align\ Both\ (nested)<TAB>' . escape(g:NERD_com_align_both_map, '\') . ' :call <SID>DoComment(1, 0, 1, 1, 0, 0, 0)<CR><ESC>'
execute 'vmenu <silent> Plugin.NERD_com.Comment\ Align\ Both\ (nested)<TAB>' . escape(g:NERD_com_align_both_map, '\') . ' :call <SID>DoComment(1, 1, 1, 1, 0, 0, 0)<CR><ESC>'
...
<leader>c<space> Toggles commenting of the lines selected. The behaviour of
this mapping depends on whether the first line selected is commented or not.
If so, all selected lines are uncommented and vice versa. The keys for this
mapping can be overridden with |NERD_com_line_toggle_map|.
...
<leader>ci Inverts the commented state of all selected lines. If a selected
line is commented then it is uncommented and vice versa. Each line is
