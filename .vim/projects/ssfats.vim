...
silent only
cd /proj/mheg-ssf/users/wenzhil/ibo_plus~prep_mheg_release_5/ibo_plus/sde2/comps/extensions/comps/mhegssf/apps/ssfats
set shortmess=aoO
badd +35 makefile
badd +0 host/root.c
badd +0 host/ThiInit.c
badd +0 host/ThiInit.h
badd +0 host/tstcases.c
badd +0 host/tstcases.h
badd +0 target/kids.c
badd +0 target/root.c
badd +0 target/stream1.c
args makefile host/root.c host/ThiInit.c host/ThiInit.h host/tstcases.c host/tstcases.h target/kids.c target/root.c target/stream1.c
...
343
normal zc
let s:l = 397 - ((130 * winheight(0) + 33) / 67)
