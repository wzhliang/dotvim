...
function! s:JavaBrowser_Skip_Buffer(bufnum)
    ...
    if getbufvar(a:bufnum, '&filetype') !=# 'java'
        return 1
    endif
...
function! s:JavaBrowser_Set_Syntax_Highlighting()
  ...
  if has('syntax')
      ...
      "Wenzhi: 
      highlight JavaBrowser_public ctermfg=darkgreen guifg=yellow 
      ...
      highlight JavaBrowser_private ctermfg=red guifg=lightblue
  
      " Colors for public, abstract members
      highlight link JavaBrowser_public_abstract JavaBrowser_public
      highlight JavaBrowser_public_abstract ctermfg=darkgreen term=italic cterm=italic guifg=orange gui=italic
      ...
      highlight JavaBrowser_public_static ctermfg=darkgreen term=underline cterm=underline guifg=orange gui=underline
      ...
      highlight JavaBrowser_public_abstract_static ctermfg=darkgreen term=italic,underline cterm=italic,underline guifg=orange gui=italic,underline
...
command! -nargs=0 JavaBrowserClose call s:JavaBrowser_Close_Window()
